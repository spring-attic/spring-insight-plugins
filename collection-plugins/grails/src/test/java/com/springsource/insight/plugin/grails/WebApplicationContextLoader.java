...
/**
 * Stolen from Dave Syer.  He had this in a org.springframework package, but it's not 
 * in any actual release.  This should be centralized so other plugins can use it.  
 *
 */
