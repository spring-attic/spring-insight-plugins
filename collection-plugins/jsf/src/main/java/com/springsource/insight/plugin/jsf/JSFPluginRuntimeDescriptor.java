...
public final class JSFPluginRuntimeDescriptor extends PluginRuntimeDescriptor {
	...
	private static final Collection<? extends EndPointAnalyzer> epAnalyzers = Collections.singletonList(JSFActionEndPointAnalyzer.getInstance());
