 ...
 * 
 * @see update_model_values_phase_operation
...
public class UpdateModelValuesPhaseViewTest extends AbstractOperationViewTestSupport {
    
    private static final OperationType TYPE = OperationType.valueOf("update_model_values_phase_operation");
    
    public UpdateModelValuesPhaseViewTest() {
        super(TYPE);
    }
    
    /**
     * This tests that {@link update_model_values_phase_operation} can be rendered via the FreeMarker
     * template.
     */
    @Test
