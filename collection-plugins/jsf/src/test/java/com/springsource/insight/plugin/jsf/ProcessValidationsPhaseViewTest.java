 ...
 * 
 * @see process_validations_phase_operation
...
public class ProcessValidationsPhaseViewTest extends AbstractOperationViewTestSupport {
    
    private static final OperationType TYPE = OperationType.valueOf("process_validations_phase_operation");
    
    public ProcessValidationsPhaseViewTest() {
        super(TYPE);
    }
    
    /**
     * This tests that {@link process_validations_phase_operation} can be rendered via the FreeMarker
     * template.
     */
    @Test
