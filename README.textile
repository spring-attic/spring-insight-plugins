...
It is a VMware® Web application that gives you real-time visibility into application behavior and performance at the code-level. Released as part of vFabric and AppInsight.
